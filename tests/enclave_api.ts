 ...
 * A402_ENABLE_PROVIDER_REGISTRATION_API=1, A402_ENABLE_ADMIN_API=1,
 * and A402_ADMIN_AUTH_TOKEN=a402-test-admin-token
 ...
 *   A402_ADMIN_AUTH_TOKEN=a402-test-admin-token \
 *   cargo run -p a402-enclave &
...
const ADMIN_AUTH_TOKEN =
  process.env.A402_TEST_ADMIN_AUTH_TOKEN ||
  process.env.A402_ADMIN_AUTH_TOKEN ||
  "a402-test-admin-token";
const ADMIN_HEADERS = {
...
const PROVIDER_MTLS: RequestTlsOptions | undefined =
  process.env.A402_TEST_MTLS_CERT_PATH &&
  process.env.A402_TEST_MTLS_KEY_PATH
    ? {
        ...SHARED_TLS,
