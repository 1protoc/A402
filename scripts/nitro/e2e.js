...
function loadNitroEnv() {
  ...
  const providerEnv =
    process.env.A402_DEMO_PROVIDERS_ENV ||
    "/root/a402-demo-providers.env";
...
async function main() {
  ...
  const plan = {
    ...
    mintAuthorityWallet:
      process.env.A402_USDC_MINT_AUTHORITY_WALLET || null,
    sourceTokenAccount:
      process.env.A402_NITRO_E2E_SOURCE_TOKEN_ACCOUNT || null,
    batchWaitAttempts,
    batchWaitDelayMs,
  };
      ...
      JSON.stringify(
        {
          ...
          dryRun: true,
          message:
            "Set A402_NITRO_E2E_CONFIRM=1 to send devnet transactions.",
          plan,
        },
        null,
        2
