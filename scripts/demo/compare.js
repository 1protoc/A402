...
printHeader("Demo narrative: official x402 vs A402 privacy-first x402");
...
console.log("[A402 privacy-first x402]");
logKV(
  "Agent action",
...
console.log(
  'Both demos request the same paid "/weather" API. Official x402 settles directly to the provider; A402 keeps the same app-level UX while routing payment through a private vault and batched payout.'
);
console.log("");

console.log("Commands for recording:");
console.log("  A402_DEMO_CONFIRM=1 yarn demo:legacy:x402-direct");
console.log("  A402_DEMO_CONFIRM=1 yarn demo:legacy:a402-private");
